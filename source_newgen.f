...
*      delayed_radioactive_decay = ...
      ...
      call read_phase_space_file( "sorgente.txt", "GeV", "cm", phase_space_entry, .false. , nomore )
...
!       print*, "Primario:"
!       print*, particle_code, momentum_energy, coordinate_x, 
!      & coordinate_y, coordinate_z, direction_cosx, direction_cosy,
!      & direction_cosz, particle_weight
